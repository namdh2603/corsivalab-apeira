...
function padding_tr($t, $r, $b, $l)
{
    $html = '';
    if ($t != null) $html .= 'padding-top:' . $t . 'rem;';
    if ($r != null) $html .= 'padding-right:' . $r . 'rem;';
    if ($b != null) $html .= 'padding-bottom:' . $b . 'rem;';
    if ($l != null) $html .= 'padding-left:' . $l . 'rem;';
    return $html;
}
function margin_tr($t, $r, $b, $l)
{
    $html = '';
    if ($t != null) $html .= 'margin-top:' . $t . 'rem;';
    if ($r != null) $html .= 'margin-right:' . $r . 'rem;';
    if ($b != null) $html .= 'margin-bottom:' . $b . 'rem;';
    if ($l != null) $html .= 'margin-left:' . $l . 'rem;';
    return $html;
}