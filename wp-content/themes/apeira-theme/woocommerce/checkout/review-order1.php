            ...
            <td class="product-name">
                ...
                <div class="product-detail">
                    ...
                    <ul>
                        <li>
                            <p>Quantity</p>
                            <span>x<?php echo apply_filters('woocommerce_checkout_cart_item_quantity', ' <strong class="product-quantity">' . sprintf('%s', $cart_item['quantity']) . '</strong>', $cart_item, $cart_item_key); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped 
											?> </span>
                        </li>
                        <?php if (!empty(get_post_meta($_product->get_id(), 'quantitative', true))) { ?>
                        <li>
                            <p>Quantitative</p>
                            <span><?php echo  get_post_meta($_product->get_id(), 'quantitative', true); ?></span>
                        </li>
                        <?php } ?>
                        <li>
                            <p>Price</p>
