            ...
            <div class="row justify-content-center">
                <div class="col-12 col-sm-4 col-md-4 col-lg-4 col-xl-4">
                    <div class="head-section">
                        ...
                        <div class="sub-thankyou"><img class="icon"
                                                       src='<?php echo get_stylesheet_directory_uri(); ?>/assets/images/check-circle.png'
                                                       alt=''><span>Thank you. Your order has been received</span></div>
                    </div>
                    <?php
                    ...
                    <div class="order-information">
                        <ul>
                            ...
                            <li><b>Order
                                    date: </b><span><?php echo wc_format_datetime($order->get_date_created()); ?></span>
                            </li>
