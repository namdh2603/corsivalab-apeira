...
<div id="reviews" class="woocommerce-Reviews">
	<div id="comments">
		<div class="row">
			<div class="col-12 col-sm-3 col-md-3 col-lg-3 col-xl-3 d-none d-lg-block">
			...
			<div class="col-12 col-sm-9 col-md-9 col-lg-9 col-xl-9">
				...
				<div class="row mb-5">
					...
					<div class="col-12 col-sm-7 col-md-7 col-lg-7">
						<?php
							$ratings_fit = $wpdb->get_var(
								$wpdb->prepare("SELECT SUM(meta_value) FROM $wpdb->commentmeta LEFT JOIN $wpdb->comments ON $wpdb->commentmeta.comment_id = $wpdb->comments.comment_ID WHERE meta_key = 'fit' AND comment_post_ID = %d AND comment_approved = '1' AND meta_value > 0",
									$product->get_id()
								)
							);
							$average_fit = round($ratings_fit / $rating_count);
						?>
							<ul class="timeline overview">
								<?php $i = 0;
								foreach ($fits as $key => $value) {
									$i++;
									echo '<li data-fit="' . $key . '"' . ($i == $average_fit ? ' class="active"' : '') . '><span>' . $value . '</span></li>';
								}
								?>
							</ul>
					</div>
...
// 																					),
						...
						<option value="1">' . esc_html__('Very poor', 'woocommerce') . '</option>
												...
												$comment_form['comment_field'] .= '<div class="comment-form-field comment-form-fit"><label for="fit">Size</label><input id="fit" name="fit" type="number" value="3" size="30" placeholder=""></div>';
