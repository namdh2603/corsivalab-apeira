							...
							<?php if (!empty($data['list'])) {
								...
								<?php foreach ($data['list'] as $item) {
									...
									<div class="accordion-item">
										<div class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapse-faq-<?php echo $i; ?>" aria-expanded="true" aria-controls="collapse-faq-<?php echo $i; ?>"><?php echo $item['title']; ?></div>
