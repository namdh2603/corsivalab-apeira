...
class PageContentTitle extends Component
{
	protected $title = 'Page Content Title';
	/**
	 * Admin Fields
	 */
...
?>
		<section class="section-<?php echo $info['component_id']; ?> pt-3" data-id="<?php echo $info['component_id']; ?>" style="<?php //echo (!empty($bg_color) ? 'background-color:' . $bg_color . ';' : ''); 
																																	?>">
			<div class="container">
